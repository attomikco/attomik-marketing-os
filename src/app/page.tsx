    ...
    <div style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hp-grid-how { grid-template-columns: 1fr !important; gap: 40px !important; }
          .hp-nav { padding: 16px 20px !important; }
          .hp-hero { padding: 100px 20px 60px !important; }
          .hp-section { padding: 60px 20px !important; }
          .hp-social { gap: 20px !important; }
          .hp-trust { gap: 12px !important; }
          .hp-step { text-align: left !important; border-left: 2px solid rgba(0,255,151,0.2); padding-left: 20px !important; }
          .hp-step .step-circle { margin-left: 0 !important; margin-right: auto !important; }
        }
        @media (max-width: 480px) {
          .hp-grid-3 { gap: 14px !important; }
          .hp-card { padding: 24px 20px !important; }
        }
      `}</style>

      {/* NAV */}
      <nav className="hp-nav" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 24px' }}>
      ...
      {/* HERO */}
      <section className="hp-hero" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '120px 24px 80px', textAlign: 'center' }}>
        ...
        <div className="hp-fade hp-fade-d5 hp-trust" style={{ display: 'flex', gap: 16, marginTop: 32, flexWrap: 'wrap', justifyContent: 'center' }}>
      ...
      {/* WHAT YOU GET */}
      <section id="example" className="hp-section" style={{ padding: '80px 24px', maxWidth: 1000, margin: '0 auto', width: '100%' }}>
        ...
        <div className="hp-grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
          {[
            ...
            <div key={label} className="hp-card" style={{ background: `${color}08`, border: `1px solid ${color}25`, borderRadius: 16, padding: '32px 28px', textAlign: 'center' }}>
      ...
      {/* HOW IT WORKS */}
      <section className="hp-section" style={{ padding: '80px 24px', maxWidth: 900, margin: '0 auto', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
        ...
        <div className="hp-grid-how" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
          {[
            ...
            <div key={num} className="hp-step" style={{ textAlign: 'center' }}>
              <div className="step-circle" style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontFamily: 'Barlow, sans-serif', fontWeight: 900, fontSize: 20, color: '#00ff97' }}>{num}</div>
      ...
      <section style={{ padding: '60px 24px', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div className="hp-social" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'clamp(16px, 4vw, 40px)', flexWrap: 'wrap' }}>
      ...
      {/* FINAL CTA */}
      <section className="hp-section" style={{ padding: '100px 24px', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: 480, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
          <input
            value={website2}
